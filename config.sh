...
ghostblog_image_name="ghostblog"
ghostblog_container_name="${ghostblog_image_name}"
ghostblog_proxy_image_name="ghostblog_proxy"
ghostblog_proxy_container_name="${ghostblog_proxy_image_name}"
